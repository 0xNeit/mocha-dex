...
abstract contract DelegatERC20 is ERC20 {
...
contract MochaToken is DelegatERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Mocha Token", "MCH") Ownable(initialOwner) {
        _owner = initialOwner;
